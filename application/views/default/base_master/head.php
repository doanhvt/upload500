...
<link rel="stylesheet" href="<?php echo $this->path_theme_file; ?>assets/css/bootstrap.min.css" />
...
<!-- ace styles -->
<link rel="stylesheet" href="<?php echo $this->path_theme_file; ?>assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
...
<script src="<?php echo $this->path_theme_file; ?>assets/js/ace-extra.min.js"></script>
...
<!--[if !IE]> -->
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.2.1.1.min.js"></script>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='<?php echo $this->path_theme_file; ?>assets/js/jquery.min.js'>" + "<" + "/script>");
</script>
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement)
        document.write("<script src='<?php echo $this->path_theme_file; ?>assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
</script>
<script src="<?php echo $this->path_theme_file; ?>assets/js/bootstrap.min.js"></script>
...
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.sparkline.min.js"></script>
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.flot.min.js"></script>
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.flot.pie.min.js"></script>
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.flot.resize.min.js"></script>
...
<script src="<?php echo $this->path_theme_file; ?>assets/js/jquery.form.min.js"></script>
